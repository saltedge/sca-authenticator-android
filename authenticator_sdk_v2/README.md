...
A client of Salt Edge Authenticator API v2 of Salt Edge SCA Service.
Implements Strong Customer Authentication/Dynamic Linking process.  
...
```groovy
    implementation ('com.saltedge.authenticator.sdk:authenticator_sdk:2.x.x@aar') {
        transitive = true
    }
```  
