...
import com.saltedge.authenticator.sdk.v2.api.ERROR_CLASS_CONNECTION_NOT_FOUND
...
import com.saltedge.authenticator.sdk.v2.api.model.error.*
...
class ApiErrorDataExtensionsTest {
    ...
    fun createRequestErrorTest() {
        assertThat(
            ...
            equalTo(
                ApiErrorData(errorClassName = ERROR_CLASS_API_RESPONSE,
