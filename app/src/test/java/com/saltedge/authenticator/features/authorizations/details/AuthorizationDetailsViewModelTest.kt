...
class AuthorizationDetailsViewModelTest {
    ...
    fun setInitialDataTest_case1() {
        ...
        //when
        viewModel.setInitialData(identifier)
        ...
        viewModel.setInitialData(AuthorizationIdentifier("1", ""))
    ...
    fun getConnectionDataForAuthorizationPollingTest() {
        ...
        viewModel.setInitialData(AuthorizationIdentifier(connectionID = "2_noKey", authorizationID = ""))

        Assert.assertNull(viewModel.getConnectionDataForAuthorizationPolling())

        viewModel.setInitialData(AuthorizationIdentifier(connectionID = "1", authorizationID = "2_noKey"))
    ...
    fun onFetchAuthorizationResultTest_case1() {
        ...
        viewModel.setInitialData(AuthorizationIdentifier(connectionID = "1", authorizationID = "1"))
