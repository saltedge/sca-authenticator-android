...
class RadialProgressPresenterTest {
    ...
    fun onViewSizeChangedTest() {
        val basePadding = TestAppTools.applicationContext.resources.getDimension(R.dimen.dp_2)
        val presenter = RadialProgressPresenter()
        ...
        val testSize = TestAppTools.applicationContext.resources.getDimension(R.dimen.dp_24)
