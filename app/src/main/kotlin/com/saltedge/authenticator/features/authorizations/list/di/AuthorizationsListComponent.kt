 ...
 */
package com.saltedge.authenticator.features.authorizations.list.di
...
@FragmentScope
@Subcomponent(modules = [(AuthorizationsListModule::class)])
interface AuthorizationsListComponent {
