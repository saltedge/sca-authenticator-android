...
class LocaleToolsTest {
    ...
    fun availableLocalizationsTest() {
        assertThat(TestTools.applicationContext.getAvailableLocalizations(), equalTo(listOf("en")))
    }
    ...
    fun applyPreferenceLocaleTest() {
        ...
        TestTools.applicationContext.applyPreferenceLocale()

        assertEquals("en", TestTools.applicationContext.getCurrentAppLocale()?.language)
    }

    @Test
    @Throws(Exception::class)
    fun updateApplicationLocaleTest() {
        TestTools.applicationContext.updateApplicationLocale(Locale("en"))

        assertEquals("Cancel", TestTools.applicationContext.getString(R.string.actions_cancel))
    }
    ...
    fun currentAppLocaleTest() {
        ...
        TestTools.setLocale("ru")

        assertEquals("ru", TestTools.applicationContext.getCurrentAppLocale()?.language)
    }
    ...
    fun languageNameTest() {
        ...
        assertEquals("Русский", TestTools.applicationContext.getCurrentAppLocale()?.languageName)
    ...
    fun currentAppLocaleLanguageNameTest() {
        ...
        assertEquals("English", TestTools.applicationContext.currentAppLocaleName())

        TestTools.setLocale("ru")

        assertEquals("Русский", TestTools.applicationContext.currentAppLocaleName())
    }
